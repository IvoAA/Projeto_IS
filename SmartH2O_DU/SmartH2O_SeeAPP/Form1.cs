...
namespace SmartH2O_SeeAPP
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Dictionary<int, List<double>> dict = serviceClient.GetSumInformationByWeek("PH");

            string result = "";
            foreach (var week in dict.Keys)
            {
                List<double> sums = dict[week];
                result += "[" + week + "H - " + (week + 1) + "H] Min: " + sums[0] + " Max: " + sums[1] + " Avg: " + sums[2] + Environment.NewLine;
            }
